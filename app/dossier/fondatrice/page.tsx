...
import {
  ...
  Monitor, ArrowLeft, AlertTriangle, User, ClipboardList,
} from "lucide-react"
...
const TAGS = [
  ...
  { label: "Migration CRM & logiciel", color: "accent" as const },
...
export default function FondatricePage() {
  return (
    <div>
      ...
      <SectionCard title="Le fil rouge : de l’immobilier au logiciel" icon={BookOpen} delay={150} className="mb-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  ...
                  biens actifs en location, en travaux, avec des recherches d&apos;acquisitions poussées.
                  <strong> Deux ans à réorganiser, optimiser, rentabiliser</strong> — et à comprendre dans la chair
                  ce dont les propriétaires ont besoin. C&apos;est ce client qui cherchait un logiciel de gestion
                  patrimoniale — introuvable sur le marché — qui a déclenché la décision de le construire.
                </p>
              </div>
            </div>
          </ScrollReveal>

          {/* Chapitre 5bis — ADN tech & CRM (NOUVEAU) */}
          <ScrollReveal delay={325}>
            <div className="flex items-start gap-4">
              <div className="w-9 h-9 rounded-full bg-[#7c3aed]/10 flex items-center justify-center flex-shrink-0 mt-1">
                <Monitor className="w-4.5 h-4.5 text-[#7c3aed]" />
              </div>
              <div>
                <p className="text-sm font-semibold text-[#7c3aed] mb-1">L&apos;ADN tech & CRM</p>
                <p className="text-sm text-slate-600 leading-relaxed">
                  Passionnée d&apos;informatique et de technologies depuis toujours, Sheana a découvert l&apos;univers
                  des CRM dès ses premiers postes. En 2022, elle pilote un projet de migration logicielle pour
                  un groupe de courtage en assurances : mapping de données, coordination avec les équipes
                  techniques, gestion des environnements de production et de test, formation de 15 collaborateurs
                  sur 3 structures différentes. Pendant deux ans, elle est la première interlocutrice en cas de
                  problème technique, organise les réunions d&apos;amélioration continue, et optimise l&apos;utilisation
                  du logiciel au quotidien.
                </p>
      ...
      <SectionCard title="Transparence & réserves" icon={AlertTriangle} delay={350} className="mb-8">
      ...
      <SectionCard title="Ce que Sheana apporte au projet" icon={Star} delay={300} className="mb-8">
      ...
      {/* --- TIMELINE DÉTAILLÉE --- */}
      <SectionCard title="Parcours professionnel" icon={ClipboardList} delay={400}>
